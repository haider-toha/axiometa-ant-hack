"""Offline build smoke test for cad/enclosure.py.

enclosure.py is a Fusion 360 add-in (top-level ``import adsk`` +
...
def test_enclosure_two_named_bodies():
